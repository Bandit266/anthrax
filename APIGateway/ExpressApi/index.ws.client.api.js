...
//     console.log('WebSocket API Client Connected With connected Port:');
// 	console.log(5005)
...
//     //         var portNum = API_End.port;
//     //         connection.sendUTF(portNum.toString());
// 	// 		// console.log(`-- ### API STREAM ###, sent: (P.O.R.T) ${number.toString()} with 5sec`);
// 	// 		console.log(portNum)
//     //         setTimeout(sendAPI, 5000);
//     //     }
//     // }
// 	// function sendAPILogs() {
//     //     if (connection.connected) {
// 	// 		console.log(relay);
//     //         // setTimeout(sendAPILogs, 5000);
//     //     }
//     // }
// 	// sendAPI();
//     // sendAPILogs();
...
client.on('connect', function(connection) {
    ...
    function sendNumber() {
        if (connection.connected) {
			...
			console.log(`-- ### API CLIENT API STREAM ###, sent: ${number.toString()} with 8sec`);
